    ...
    config.append('''subgraph REF {
        ...
        Referencias[shape=none, color=white, margin=0, width=2, label=<
            <TABLE BORDER="1" CELLBORDER="1" CELLSPACING="0" CELLPADDING="4">
                <TH>
                    <TD COLSPAN="3" COLOR="white"><FONT FACE="Arial" COLOR="white" POINT-SIZE="18"><B>Referencias</B></FONT></TD>
                </TH>
                <TR>
                    ...
                    <TD COLSPAN="1" ALIGN="LEFT" COLOR="white"><FONT FACE="Arial" COLOR="white" POINT-SIZE="12">Celda del laberinto libre (camino)</FONT></TD>
                </TR>
                <TR>
                    <TD COLSPAN="2" COLOR="white">
                        <TABLE BORDER="0">
                    ...
                    <TD COLSPAN="1" ALIGN="LEFT" COLOR="white"><FONT FACE="Arial" COLOR="white" POINT-SIZE="12">Celda del laberinto bloqueada (pared)</FONT></TD>
                </TR>
                <TR>
                    <TD COLSPAN="2" COLOR="white">
                        <TABLE BORDER="0">
                    ...
                    <TD COLSPAN="1" ALIGN="LEFT" COLOR="white"><FONT FACE="Arial" COLOR="white" POINT-SIZE="12">Celda inicial o final</FONT></TD>
                </TR>
                <TR>
                    <TD COLSPAN="2" COLOR="white">
                        <TABLE BORDER="0">
                    ...
                    <TD COLSPAN="1" ALIGN="LEFT" COLOR="white"><FONT FACE="Arial" COLOR="white" POINT-SIZE="12">Celda expandida pero no visitada (quedó en memoria)</FONT></TD>
                </TR>
                <TR>
                    <TD COLSPAN="2" COLOR="white">
                        <TABLE BORDER="0">
                    ...
                    <TD COLSPAN="1" ALIGN="LEFT" COLOR="white"><FONT FACE="Arial" COLOR="white" POINT-SIZE="12">Celda que es parte del camino solución</FONT></TD>
                </TR>
            </TABLE>
        >]
    }''')
